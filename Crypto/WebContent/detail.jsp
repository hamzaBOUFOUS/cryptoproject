...
out.println(new Date());
 ...
 while(rs.next()){
    ...
    <div class="container-fluid">
        ...
        <%
    if(session.getAttribute("agent") !=null){
	    if(request.getParameter("idcmt") != null){
	    	Class.forName("com.mysql.jdbc.Driver");
	    	  cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/cryptonews","root","");
	    	  st=cn.createStatement();
	    	   String req="insert into commentaire values(null,'"+request.getParameter("message")+"','"+LocalDate.now()+"', 1,"+request.getParameter("idcmt")+","+session.getAttribute("agent")+")";
	    	st.executeUpdate(req);
	    }
	}else if(request.getParameter("idcmt") != null){
		%>
                <div class="alert alert-danger alert-dismissable">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                	<a href="#" class="alert-link">Il faut Connecte pour commente</a>.
         		</div>
		<%
	}
    	%>
       ...
       <% 
        try {  
    		...
    		st=cn.createStatement();
   			...
   			String req="select * from news n,categorie c where n.id_cat=c.id_cat and id_n="+request.getParameter("id");
 			rs=st.executeQuery(req);
 			if(rs.next()){
       			%>                            
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="mb-3">
                                ...
                                <a class="text-body" href=""><% SimpleDateFormat sdf=new SimpleDateFormat("dd/MM/yyy"); out.print(sdf.format(new Date())); %></a>
                            </div>
                            <h1 class="mb-3 text-secondary text-uppercase font-weight-bold"><% out.print(rs.getString(2)); %></h1>
                            <p>
       ...
       <% 
    		...
    		st=cn.createStatement();
   			...
   			req="select COUNT(*) as cnt FROM commentaire where commentaire.id_n = "+request.getParameter("id");
 			rs=st.executeQuery(req);
 			if(rs.first()){
       			%>    
                                <span class="ml-3"><i class="far fa-comment mr-2"></i><% out.print(rs.getInt("cnt")); %></span>
                <%
 			}else{
            ...
            System.out.println(ex.getMessage());      
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0">
                            <h4 class="m-0 text-uppercase font-weight-bold">Commentaires</h4>
                        </div>
  ...
  st=cn.createStatement();
   ...
   String req="select * from commentaire, membre where membre.id_m = commentaire.id_m and commentaire.statu=1 and commentaire.id_n="+request.getParameter("id");
 rs=st.executeQuery(req);
 while(rs.next()){
       %>
                        ...
                        <div class="bg-white border border-top-0 p-4">
                            <div class="media mb-4">
                                <img src="<% out.print(rs.getString(11)); %>" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                <div class="media-body">
                                    <h6><a class="text-secondary font-weight-bold" href="#"><% out.print(rs.getString(8)); %></a> <small><i><% out.print(rs.getString(3)); %></i></small></h6>
            ...
            System.out.println(ex.getMessage());      
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0">
                            <h4 class="m-0 text-uppercase font-weight-bold">Commenter</h4>
                        </div>
                        <div class="bg-white border border-top-0 p-4">
                            <form action="detail.jsp?id=<% out.print(request.getParameter("id")); %>&idcmt=<% out.print(request.getParameter("id")); %>" method="POST">
 ...
 while(rs.next()){
       %>
                              ...
                              <a href="#" class="btn btn-sm btn-outline-secondary m-1"><% out.print(rs.getString(2)); %></a>
