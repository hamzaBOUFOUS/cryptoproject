 ...
 while(rs.next()){
       %>
            ...
            System.out.println(ex.getMessage());      
                    ...
                    <a href="contact.jsp" class="nav-item nav-link active">Contactez-nous</a>
                    <% if(session.getAttribute("agent") == null){ %>
    ...
    <div class="container-fluid mt-5 pt-3">
        ...
        if(request.getParameter("send") != null){
            ...
            <div class="alert alert-info alert-dismissable">
                           ...
                           <a href="#" class="alert-link">mail sent successfully</a>.
                       </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">Contactz-Nous</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h6 class="font-weight-bold mb-0">Localisation</h6>
                                </div>
                                <p class="m-0">EST LAAYOUNE,LAAYOUNE</p>
                            </div>
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2">
                                ...
                                <p class="m-0">CRYPTONEWS@GMAIL.com</p>
                            </div>
                            <div class="mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <i class="fa fa-phone-alt text-info mr-2"></i>
                                    <h6 class="font-weight-bold mb-0">Telephone</h6>
                                </div>
                                <p class="m-0">+2123658689</p>
                            </div>
                        </div>
                        <h6 class="text-uppercase font-weight-bold mb-3">Contact </h6>
                        <form method="POST" action="contact.jsp?send=true">
                            <div class="form-row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="email" name="mail" class="form-control p-4" placeholder="Email" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control p-4" name="sub" placeholder="Sujet" required="required"/>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="mess" rows="4" placeholder="Message" required="required"></textarea>
                            </div>
                            <div>
