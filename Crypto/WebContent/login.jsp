 ...
 while(rs.next()){
    ...
    <div class="container-fluid mt-5 pt-3">
        ...
        if(request.getParameter("logout") == null){
	        ...
	        } else if(request.getParameter("email") != null && request.getParameter("pwd") != null){
	      	  Class.forName("com.mysql.jdbc.Driver");
	      	  cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/cryptonews","root","");
	      	    st=cn.createStatement();
	      	   String req="select * from membre where email = '"+request.getParameter("email")+"' and mot = '"+request.getParameter("pwd")+"'";
	        		rs =st.executeQuery(req);
	        		if(rs.first()) {
	        			request.getSession().setAttribute("agent", rs.getInt(1));
	    	        	response.sendRedirect("index.jsp?login1=true");
	             	} else{
	             		%>
	             		
	                 <div class="alert alert-danger alert-dismissable">
	                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
	                                <a href="#" class="alert-link">Error! Email or Password Incorrect</a>.
	                            </div>
	             		<%
	             	}
	        }
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title mb-0">
                        <h4 class="m-0 text-uppercase font-weight-bold">AUTHENTIFICATION</h4>
                    </div>
                    <div class="bg-white border border-top-0 p-4 mb-3">
                        ...
                        <form method="POST" action="login.jsp">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control p-4" name="pwd" placeholder="Password" required="required"/>
                            </div>
