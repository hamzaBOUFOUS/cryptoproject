...
out.println(new Date());
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Categories</a>
 ...
 while(rs.next()){
  ...
  st=cn.createStatement();
   ...
   String req="select * from news n,categorie c where n.id_cat=c.id_cat and n.id_cat="+request.getParameter("cat")+" ORDER by id_n DESC ";
 rs=st.executeQuery(req);
 while(rs.next()){
       %>
