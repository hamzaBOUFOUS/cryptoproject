...
<%@include file="includes/menu.jsp" %>
  ...
  st=cn.createStatement();
   String req="insert into news( `titre`, `image`, `news`, `id_cat`) values('"+t+"','"+im+"','"+n+"',"+ct+")";
          ...
          <%
            ...
            out.println(ex.getMessage());      
                         ...
                         %>		
                                    ...
                                    <div style="margin-right:20px;margin-left:20px;" class="widget">
					<div class="widget-header transparent">
						<h2><strong>Ajouter News</strong></h2>
					...
					<div class="widget-content padding">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input type="text" name="tit" class="form-control" id="input-text" placeholder="">
							</div>
						  </div>
            ...
            System.out.println(ex.getMessage());      
                         ...
                         %>  
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
                                                            <textarea name="new" class="summernote"></textarea>
							</div>
						  </div>
