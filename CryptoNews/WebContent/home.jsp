...
<%@include file="includes/menu.jsp" %>
					...
					<div class="col-lg-3 col-md-6">
						<div class="widget green-1 animated fadeInDown">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>Des Visiteurs</b></p>
									<h2><span class="animate-number" data-value="20" data-duration="3000">0</span></h2>
  ...
  cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/cryptonews","root","");
   ...
   String req="SELECT count(*) FROM `news`";
 ...
 rs.next();
  nu=rs.getInt(1);
            ...
            out.println(ex.getMessage());      
                         ...
                         %> 
									<p class="maindata">TOTAL <b>NEWS</b></p>
									<h2><span class="animate-number" data-value="<% out.print(nn); %>" data-duration="3000">0</span></h2>
					...
					<div class="col-lg-3 col-md-6">
						<div class="widget orange-4 animated fadeInDown">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>COMPTE </b></p>
									<h2><span class="animate-number" data-value="<% out.print(nc); %>" data-duration="3000">0</span></h2>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="widget-footer">
					...
					<div class="col-lg-3 col-md-6">
						<div class="widget lightblue-1 animated fadeInDown">
							<div class="widget-content padding">
								...
								<div class="text-box">
									<p class="maindata">TOTAL <b>UTILISATEUR</b></p>
									<h2><span class="animate-number" data-value="<% out.print(nu); %>" data-duration="3000">0</span></h2>
									<div class="clearfix"></div>
								</div>
							</div>
							<div class="widget-footer">
