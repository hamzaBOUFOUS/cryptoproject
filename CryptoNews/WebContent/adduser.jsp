...
<%@include file="includes/menu.jsp" %>
    ...
    <!-- Right Sidebar End -->		
        ...
        <div class="content-page">
            ...
            String m=request.getParameter("ps");
  ...
  String req1="select * from utilisateur where nom ='"+nom+"'";
  ...
  if(rs.first()){
	  ...
	  Statement st1 =  cn.createStatement();;
	   String req="insert into utilisateur values('"+nom+"','"+m+"','"+tp+"','"+im+"')";
       st1.executeUpdate(req);

       %>
                 <div class="alert alert-info alert-dismissable" style="margin: 20px">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                <a href="#" class="alert-link">Bien ajoutée</a>.
                            </div>
          <%
  }
            ...
            out.println(ex.getMessage());      
                         ...
                         %>
                                    ...
                                    <div style="margin:20px;" class="widget">
					<div class="widget-header transparent">
						<h2><strong>Ajouter Utilisateur</strong></h2>
					...
					<div class="widget-content padding">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
                                                            <input type="text" name="nm" class="form-control" id="input-text" placeholder="">
							</div>
						  </div>
                                                      <div class="form-group">
							<label for="input-text" class="col-sm-2 control-label">Mot de Passe</label>
							<div class="col-sm-10">
							  <input type="password" name="ps" class="form-control" id="input-text" placeholder="">
							</div>
						  </div>
							  <div class="form-group">
				  ...
				  <button type="submit" class="btn btn-primary">Valider</button>
                                                   <input type="reset" class="btn btn-primary" name="username">
