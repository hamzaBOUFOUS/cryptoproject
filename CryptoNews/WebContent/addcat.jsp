...
<%@include file="includes/menu.jsp" %>
  ...
  st=cn.createStatement();
   String req="insert `categorie` (`libelle`, `description`) values('"+lib+"','"+des+"')";
					...
					<div class="col-sm-12 portlets">
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong>Nouvelle categorie</strong> </h2>
							...
							<div class="widget-content padding">
                                                            <form method="post" action="" role="form" id="registerForm">
								  <div class="form-group">
									<label>Libelle</label>
									<input name="lib" type="text" class="form-control" name="username">
								  </div>
								   <div class="form-group">
									<label>Description</label>
									<textarea name="des" class="form-control" name="Contactmessage" style="height: 140px; resize: none;"></textarea>
								  </div>
