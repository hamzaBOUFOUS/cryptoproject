...
<%@include file="includes/menu.jsp" %>
  ...
  st=cn.createStatement();
     if (request.getParameter("idm") != null) {
       st.executeUpdate("delete from membre where id_m='"+request.getParameter("idm")+"' ");
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong>Les Membres</strong> </h2>
 ...
 while(rs.next()){
       %>
                              ...
                              <td><% out.print(rs.getString(2)); %></td>
                               ...
                               <td><img src="<% out.print(rs.getString(5)); %>" width="60" height="60" ></td>
												<td>
									<div class="btn-group btn-group-xs">
														<a href="managecompte.jsp?idm=<% out.print(rs.getString(1)); %> " data-toggle="tooltip" title="Supprimer" class="btn btn-default"><i class="fa fa-power-off"></i></a>
